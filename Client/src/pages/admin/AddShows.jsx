...
// import Title from '../../components/admin_Components/Title';
...
//         //     }
//         // } catch (error) {
//         //     console.error('error for fatching movie :',error)
//         // }
...
//         try {
//             setAddingShow(true)
//             if(!selectedMovies || Object.key(dateTimeSelection).length === 0 || !showPrice){
...
// //                         <div className='relative rounded-lg overflow-hidden' onClick={()=> setSelectedMovies(movie.id)}>
...
// //             <div className='inline-flex items-center gap-5 border border-gray-600 p-1 pl-3 rounded-md'>
